    ...
    a.fn.ace_wysiwyg = function (b, c) {
        var d = a.extend({speech_button: !0, wysiwyg: {}}, b),
            e = [
                ...
                "#0d74e7", "#8573ff", "#a82dff", "#c200a2", "#ca86c9",
                "#000000", "#333333", "#777777", "#bbbbbb", "#ffffff"
            ],
            f = {
                font: {
                    values: [
                        "宋体", "微软雅黑", "黑体", "仿宋", "楷体", "隶书", "幼圆",
                        "Arial", "Courier", "Comic Sans MS", "Helvetica", "Open Sans", "Tahoma", "Verdana"
                    ],
                    icon: "fa fa-font",
                    title: "字体"
                },
                fontSize: {
                    values: {7: "H1", 6: "H2", 5: "H3", 4: "H4", 3: "H5", 2: "H6", 1: "H7"},
                ...
                insertunorderedlist: {icon: "fa fa-list-ul", title: "无序列表"},
                insertorderedlist: {icon: "fa fa-list-ol", title: "有序列表"},
                outdent: {icon: "fa fa-outdent", title: "减少缩进 (Shift+Tab)"},
                indent: {icon: "fa fa-indent", title: "缩进 (Tab)"},
                justifyleft: {icon: "fa fa-align-left", title: "靠左 (Ctrl/Cmd+L)"},
                justifycenter: {icon: "fa fa-align-center", title: "居中 (Ctrl/Cmd+E)"},
                justifyright: {icon: "fa fa-align-right", title: "靠右 (Ctrl/Cmd+R)"},
                justifyfull: {icon: "fa fa-align-justify", title: "两边对齐 (Ctrl/Cmd+J)"},
                createLink: {
                    icon: "fa fa-link",
                    title: "链接",
                    button_text: "添加",
                ...
                unlink: {icon: "fa fa-chain-broken", title: "删除链接"},
                insertImage: {
                    icon: "fa fa-picture-o",
                    title: "插入图片",
                    button_text: '<i class="' + ace.vars.icon + 'fa fa-file"></i> 上传图片 &hellip;',
                    placeholder: "图片地址",
                    button_insert: "插入",
                ...
                foreColor: {values: e, title: "换文字色"},
                backColor: {values: e, title: "换背景色"},
                undo: {icon: "fa fa-undo", title: "后退 (Ctrl/Cmd+Z)"},
                redo: {icon: "fa fa-repeat", title: "前进 (Ctrl/Cmd+Y)"},
                viewSource: {icon: "fa fa-code", title: "查看源代码"}
            },
            g = d.toolbar || ["font", null, "fontSize", null, "bold", "italic", "strikethrough", "underline",
                null, "insertunorderedlist", "insertorderedlist", "outdent", "indent", null, "justifyleft", "justifycenter", "justifyright", "justifyfull",
                null, "createLink", "unlink", null, "insertImage", null, "foreColor", "backColor", null, "undo", "redo", null, "viewSource"];
        return this.each(function () {
