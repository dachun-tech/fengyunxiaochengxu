Component({
    properties: {
        ...
        /**         * 图片宽度         */
        'img_width': { type: null, value: null },

        /**         * 图片高度         */
        'img_height': { type: null, value: null },
        ...
        /**         * 最小缩放比         */
        'min_scale': { type: Number, value: 0.5 },

        /**         * 最大缩放比         */
        'max_scale': { type: Number, value: 2 },

        /**         * 是否禁用旋转         */
        'disable_rotate': { type: Boolean, value: true },

        /**         * 是否限制移动范围(剪裁框只能在图片内)         */
        'limit_move': { type: Boolean, value: true }
    },
    data: {
        ...
        _touch_img_relative: [{ x: 0, y: 0 }], //鼠标和图片中心的相对位置
    ...
    attached() {
        ...
        this.setData({ _canvas_height: this.data.height, _canvas_width: this.data.width, });
        this._initCanvas();
    ...
    methods: {
         ...
         */
        setCutXY(x, y) {
            this.setData({ cut_top: y, cut_left: x });
        },
